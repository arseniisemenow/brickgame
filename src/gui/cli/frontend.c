...
// Function to perform an HTTP GET request using cURL to retrieve game
// parameters
...
void HandleCarRacingLoop() {
  ...
  while (1) {
    ...
    //    if (input == 'a') {
    //      SendAction("{\"action\": \"move_left\"}");
    //    } else if (input == 'd') {
    //      SendAction("{\"action\": \"move_right\"}");
    //    } else if (input == 's') {
    //      SendAction("{\"action\": \"move_down\"}");
    //    } else if (input == ' ') {
    //      SendAction("{\"action\": \"rotate\"}");
    //    }
    //
