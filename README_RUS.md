...
Напоминаем, что для формализации логики игры тебе необходимо использовать конечные автоматы. Чтобы освежить свои знания, описание и примеры КА ты можешь найти `materials/brick-game-v1.0.md`.
...
- У игровой библиотеки должен быть универсальный интерфейс, описанный в файле `materials/library-specification.md`.
